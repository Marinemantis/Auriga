              ...
              <div>
                ...
                <div className="flex flex-col gap-0 divide-y divide-[#1a1a1a]">
                  ...
                  <div className="py-6">
                    ...
                    <p className="text-[#F5F0E8]/80 text-[15px]" style={{ fontFamily: "var(--font-inter),sans-serif" }}>Islamabad, Pakistan</p>
                  </div>
      ...
      <footer className="border-t border-[#111] py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-baseline gap-1">
            <span className="text-[20px] font-semibold text-[#F5F0E8]" style={{ fontFamily: "var(--font-cormorant),Georgia,serif" }}>Auriga</span>
            <span className="text-[20px] font-light text-[#C8903A]"    style={{ fontFamily: "var(--font-cormorant),Georgia,serif" }}>Ventures</span>
          </div>
          <p className="text-[#F5F0E8]/20 text-xs" style={{ fontFamily: "var(--font-inter),sans-serif" }}>
            © 2026 Auriga Ventures. Beyond Travel. We Curate Dreams.
          </p>
          <div className="flex gap-5">
            <a href="https://www.instagram.com/aurigaventures/" target="_blank" rel="noopener noreferrer"
              className="text-[#F5F0E8]/25 hover:text-[#C8903A] transition-colors duration-300">
