              ...
              <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#080808;">
                      ...
                      <tr>
                        <td style="padding:20px 24px;">
                          ...
                          <p style="margin:0;font-family:Arial,sans-serif;font-size:13px;color:#F5F0E8;">
                            <span style="color:#888;display:inline-block;width:100px;">Destination</span>
                ...
                <tr>
                  <td style="padding:0 48px 32px;">
                    ...
                    <p style="margin:0;font-family:Georgia,serif;font-size:15px;color:#F5F0E8;line-height:1.7;font-style:italic;">"${message}"</p>
                  </td>
                </tr>
                ` : ""}
