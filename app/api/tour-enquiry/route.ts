...
export async function POST(request: Request) {
  ...
  try {
              ...
              <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#080808;">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="background:#111;border:1px solid #1e1e1e;">
                      <tr>
                        <td style="padding:20px 24px;">
                          ...
                          <p style="margin:0 0 8px;font-family:Arial,sans-serif;font-size:13px;color:#F5F0E8;">
                            <span style="color:#888;display:inline-block;width:100px;">Tour</span>${tourName}
                          </p>
                          <p style="margin:0 0 8px;font-family:Arial,sans-serif;font-size:13px;color:#F5F0E8;">
                            <span style="color:#888;display:inline-block;width:100px;">Travel dates</span>${dates || "Not specified"}
                          </p>
                          <p style="margin:0 0 8px;font-family:Arial,sans-serif;font-size:13px;color:#F5F0E8;">
                ...
                <tr>
                  <td style="padding:0 48px 32px;">
                    <p style="margin:0 0 12px;font-family:Arial,sans-serif;font-size:10px;letter-spacing:3px;text-transform:uppercase;color:#555;">Their Message</p>
                ...
                <tr>
                  <td style="padding:0 48px 48px;">
                    <a href="mailto:${email}?subject=Re%3A%20Your%20Enquiry%20-%20${encodeURIComponent(tourName)}"
    ...
    console.error("Tour enquiry email error:", error);
