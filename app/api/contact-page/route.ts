              ...
              <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#080808;">
                ...
                <tr><td style="padding:0 48px 24px;">
                  <table width="100%" cellpadding="0" cellspacing="0" style="background:#111;border:1px solid #1e1e1e;"><tr><td style="padding:20px 24px;">
                    ...
                    <p style="margin:0 0 6px;font-family:Arial,sans-serif;font-size:13px;color:#F5F0E8;"><span style="color:#888;display:inline-block;width:80px;">Email</span><a href="mailto:${email}" style="color:#C8903A;text-decoration:none;">${email}</a></p>
